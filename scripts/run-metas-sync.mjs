#!/usr/bin/env node
/**
 * Dispara manualmente o sync do agente metas.
 *
 * Uso:
 *   node scripts/run-metas-sync.js
 *   node scripts/run-metas-sync.js --url http://10.0.0.20:3000
 *
...
const url = `${base.replace(/\/$/, '')}/agente/metas/run`;
